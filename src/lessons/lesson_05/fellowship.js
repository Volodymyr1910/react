...
// пример не дефолтного, а именного експорта, который совершает експорт нескольких обьектов
export const fellowshipArray2 = [
    {
        id: 1,
        name: "Gendalf",
        age: 2000,
...
export const colorArray = ["red", "green", "blue"]
